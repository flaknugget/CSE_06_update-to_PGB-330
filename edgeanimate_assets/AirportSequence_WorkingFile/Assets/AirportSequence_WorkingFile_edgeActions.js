...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_BPCopy2}","click",function(sym,e){sym.play("BP_SkipCrossFade");});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_exit_icon_groupCopy2}","click",function(sym,e){parent.closeOverlay();});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",20372,function(sym,e){sym.stop();});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_BP_Mana_group}","click",function(sym,e){sym.play("BP_Mana");});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",22500,function(sym,e){sym.stop();});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_BP_Every_group}","click",function(sym,e){sym.play("BP_Everyone");});
//Edge binding end
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_BTS_icon_group}","click",function(sym,e){iconSelect="none";sym.play("BtnScreen");});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",26250,function(sym,e){sym.stop();});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_ViewBestPractices_text}","click",function(sym,e){sym.play("BP_SkipCrossFade");});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_exit_icon_group}","click",function(sym,e){parent.closeOverlay();});
//Edge binding end
